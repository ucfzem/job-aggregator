...
export default function JobsPage({ searchParams }: { searchParams: { q?: string; location?: string; remote?: string; salaryMin?: string; salaryMax?: string; days?: string; seniority?: string; page?: string } }) {
